...
function create_table(jsonResponse, object, route, selects=false) {
	...
	const base_table = 'weapon-table-table';
	const base_cell_title = 'weapon-table-cell-title ';
	const base_title = 'weapon-table-title'
	const base_titles = 'weapon-table-titles';
...
function create_titles(jsonResponse, grow, object, route, selects=false) {
	...
	const base_table = 'weapon-table-table';
	const base_cell_title = 'weapon-table-cell-title';
	const base_title = 'weapon-table-title-table';
	const base_titles = 'weapon-table-titles';
...
function cells_create(table_input, grow, jsonResponse, object, route, selects=false) {
	...
	const base_cells = 'weapon-table-cells';
	const base_cell = 'weapon-table-cell'
	const base_button_check = 'weapon-check-button ';
	const base_check = 'weapon-check';
	const base_entry = 'weapon-table-row';
