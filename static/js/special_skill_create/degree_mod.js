...
function deg_mod_submit() {
	...
	let type_field = document.getElementById('deh_mod_type');
	...
	let nullify = nullify_field.options[nullify_field.selectedIndex].value;
	let key = document.getElementById('deg_mod_keyword').value;
	let desc = document.getElementById('deg_mod_desc').value;

	
	if ((target != '' && deg_value != '' && type != '' && key != '' && desc != '') || (target != '' && deg_value != '' && type != '' && damage_type == 'math' && damage_math1 != '' && damage_math2 != '' && damage_val1 !=  '' && damage_val2 != '' && key != '' && desc != '') || (target != '' && deg_value != '' && type != '' && key != '' && desc != '' && damage_deg_val != '' && damage_type == 'value' && damage_val != '') || (target != '' && deg_value != '' && type != '' && key != '' && desc != '' && measure_type == 'value' && measure_value != '' && measure_rank != '') || (target != '' && deg_value != '' && type != '' && key != '' && desc != '' && measure_type == 'math' && measure_math != '' && measure_val1 != '' && measure_val2 != '' && measure_math_rank != '') || (target != '' && deg_value != '' && type != '' && key != '' && desc != '' && condition1 != '' && condition2 != '')) {
		...
		if (type == 'damage') {
			if (damage_type == 'math') {
				effect = damage_val1 + ' ' + damage_math1 + ' ' + damage_val2 + ' ' + damage_math2;
