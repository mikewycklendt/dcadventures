...
function defense_immunity_consequence() {
	...
	const checks = ['defense_immunity_fall_surface', 'defense_immunity_fall_stop'];
...
function defense_submit() {
	...
	const immunity_fall_stop = check("defense_immunity_fall_stop");
	...
	const immunity_except = check("defense_immunity_except")
