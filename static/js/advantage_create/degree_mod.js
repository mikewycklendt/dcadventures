...
function deg_mod_submit() {
	...
	response = fetch('/advantage/degree/create', {
		method: 'POST',
		body: JSON.stringify({
	...
	.then(jsonResponse => {
		...
		if (jsonResponse.success) {
			...
			const route = '/advantage/degree/delete/'
			create_table('advantage', jsonResponse, deg_mod_grid, route, [selects], title_id, [select_title]);
