...
function create_table(jsonResponse, object, route, selects=false) {
	...
	const base_table = 'armor-table-table';
	const base_cell_title = 'armor-table-cell-title ';
	const base_title = 'armor-table-title'
	const base_titles = 'armor-table-titles';
...
function create_titles(jsonResponse, grow, object, route, selects=false) {
	...
	const base_table = 'armor-table-table';
	const base_cell_title = 'armor-table-cell-title';
	const base_title = 'armor-table-title-table';
	const base_titles = 'armor-table-titles';
...
function cells_create(table_input, grow, jsonResponse, object, route, selects=false) {
	...
	const base_cells = 'armor-table-cells';
	const base_cell = 'armor-table-cell'
	const base_button_check = 'armor-check-button ';
	const base_check = 'armor-check';
	const base_entry = 'armor-table-row';
