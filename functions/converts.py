...
def db_integer(table, value, exception=False):
	...
	if value == 'all':
		...
		try:
			query = db.session.query(table).filter_by(time=True).first()
			value = query.id
		except:
			print(value)
			return (value)
		...
		try:
			query = db.session.query(table).filter_by(distance=True).first()
			value = query.id
		except:
			print(value)
			return (value)
		...
		try:
			query = db.session.query(table).filter_by(speed=True).first()
			value = query.id
		except:
			print(value)
			return (value)
		...
		try:
			query = db.session.query(table).filter_by(same=True).first()
			value = query.id
		except:
			print(value)
			return (value)
